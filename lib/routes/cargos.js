...
var Cargo1 = require('../Models/cargos');
...
router.searchCompanyReputationByCargoId = function (req, res) {
    res.setHeader('Content-Type', 'application/json');
...
router.addCargo = function (req, res) {
    ...
    if (req.body.name != null && req.body.price != null && req.body.amount != null && req.body.providerName != null && req.body.providerType != null && req.body.providerID != null) {
 ...
 */
router.deleteCargoById = function (req, res) {
 ...
 */
router.changeCargoPrice = function (req, res) {
    res.setHeader('Content-Type', 'application/json');
...
router.changeCertainPrice = function (req, res) {
    res.setHeader('Content-Type', 'application/json');
    Cargo1.find({ providerName: req.params.providerName }, function (err, cargos123) {
        if (err) {
            res.send("Error!!!");
...
router.editCargo = function (req, res) {
    res.setHeader('Content-Type', 'application/json');
    var conditions = { _id: req.params.id },
...
router.changeCargoAmount = function (req, res) {
    res.setHeader('Content-Type', 'application/json');
...
router.changeCertainAmount = function (req, res) {
    res.setHeader('Content-Type', 'application/json');
    Cargo1.find({ providerName: req.params.providerName }, function (err, cargos123) {
        if (err) {
            res.send("Error!!!");
...
router.changeCertainProvider = function (req, res) {
    res.setHeader('Content-Type', 'application/json');
    Cargo1.find({ providerName: req.params.providerName }, function (err, cargos123) {
        if (err) {
            res.send("Error!!!");
...
function getTotalCost(array) {
    ...
    array.forEach(function (obj) {
        cost += obj.price * obj.amount;
    });
    return cost;
}
router.totalCost = function (req, res) {
    res.setHeader('Content-Type', 'application/json');
...
router.certainCost = function (req, res) {
    res.setHeader('Content-Type', 'application/json');
